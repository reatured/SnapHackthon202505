...
var Module = require("../../../../../Modules/Src/Assets/SpectaclesSyncKit/Utils/SyncKitLogLevelConfiguration");
Object.setPrototypeOf(script, Module.SyncKitLogLevelConfiguration.prototype);
script.__initialize();
if (script.onAwake) {
   script.onAwake();
}
