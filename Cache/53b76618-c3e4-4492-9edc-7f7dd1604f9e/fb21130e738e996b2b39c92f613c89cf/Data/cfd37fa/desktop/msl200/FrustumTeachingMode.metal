...
Output_N97=mix(Output_N45,(*sc_set0.UserUniforms).Port_Input1_N097,float4(FrontFacing_N96));
...
float3x3 param_30=(*sc_set0.UserUniforms).Tweak_N99Transform;
...
float4 param_33=(*sc_set0.UserUniforms).Tweak_N99UvMinMax;
bool param_34=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N99_tmp)!=0);
float4 param_35=(*sc_set0.UserUniforms).Tweak_N99BorderColor;
float param_36=0.0;
...
float Noise_N83=0.0;
float2 param_37=(*sc_set0.UserUniforms).Port_Seed_N083;
...
float param_43=(*sc_set0.UserUniforms).alpha;
Output_N85=param_43;
