...
let ContainerFrame = class ContainerFrame extends BaseScriptComponent {
    ...
    onAwake() {
        ...
        this.unSubscribeList.push(this.interactable.onTriggerUpdate((event) => {
            if (event.interactor.targetHitInfo && this.inputHandler.state.scaling) {
                ...
                if (newInnerSize.x > this.minimumSize.x &&
                    ...
                    this.interactionPlane.planeSize = this.totalInnerSize.add(vec2.one().uniformScale(this.border * 2));
                }
            }
        }));
        ...
        this.interactionPlane = this.sceneObject.createComponent(InteractionPlane_1.InteractionPlane.getTypeName());
        this.interactionPlane.planeSize = this.totalInnerSize.add(vec2.one().uniformScale(this.border * 2));
