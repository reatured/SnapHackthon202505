...
{
vec4 l9_50=l9_46;
l9_50.x=l9_46.x+(sc_UniformConstants.x*float(sc_ShaderCacheConstant));
l9_49=l9_50;
}
#else
{
...
{
float l9_51=dot(l9_49,sc_StereoClipPlanes[sc_StereoViewID]);
...
#else
{
vec2 l9_21=sc_ScreenCoordsGlobalToView(gl_FragCoord.xy*sc_CurrentRenderTargetDims.zw);
int l9_22;
...
#endif
l9_17=texture2D(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_21,sc_ScreenTextureLayout,l9_22).xy,0.0);
}
#endif
vec4 l9_23;
...
#if (sc_OITCompositingPass)
{
vec2 l9_50=sc_ScreenCoordsGlobalToView(gl_FragCoord.xy*sc_CurrentRenderTargetDims.zw);
#if (sc_OITMaxLayers4Plus1)
{
