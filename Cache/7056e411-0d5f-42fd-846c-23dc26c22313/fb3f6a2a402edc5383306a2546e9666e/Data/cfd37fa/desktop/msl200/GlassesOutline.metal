...
//}
//ubo int UserUniforms 0:24:4048 {
...
//float Tweak_N19 4004
//float4 Tweak_N6 4016
//float alpha 4032
//}
...
float param_1=(*sc_set0.UserUniforms).Tweak_N19;
Output_N19=param_1;
...
int l9_133=l9_132;
l9_131=((*sc_set0.UserUniforms).sc_ModelViewMatrixArray[l9_133]*param_2.position)*float4(1.0/(*sc_set0.UserUniforms).sc_Camera.aspect,1.0,1.0,1.0);
}
else
{
if (sc_RenderingSpace_tmp==2)
...
float4 param=(*sc_set0.UserUniforms).Tweak_N6;
Output_N6=param;
...
{
l9_15.x+=(*sc_set0.UserUniforms)._sc_framebufferFetchMarker;
}
float4 l9_16=l9_15;
l9_13=l9_16;
}
...
float l9_55=l9_47;
float4 l9_56=sc_set0.sc_ScreenTexture.sample(sc_set0.sc_ScreenTextureSmpSC,l9_54,bias(l9_55));
float4 l9_57=l9_56;
l9_43=l9_57;
float4 l9_58=l9_43;
float4 l9_59=l9_58;
...
float3 l9_66=definedBlend(l9_64,l9_65,in.varStereoViewID,(*sc_set0.UserUniforms),sc_set0.intensityTexture,sc_set0.intensityTextureSmpSC);
...
{
l9_74=float4((*sc_set0.UserUniforms).shaderComplexityValue/255.0,0.0,0.0,1.0);
}
else
{
l9_74=float4(0.0);
...
FinalColor=outputMotionVectorsIfNeeded(param_4,param_5,in.varStereoViewID,(*sc_set0.UserUniforms));
float4 param_6=FinalColor;
float4 l9_76=param_6;
if (sc_ShaderCacheConstant_tmp!=0)
{
l9_76.x+=((*sc_set0.UserUniforms).sc_UniformConstants.x*float(sc_ShaderCacheConstant_tmp));
}
