...
//sampler sampler Tweak_N1SmpSC 0:22
...
//texture texture2D Tweak_N1 0:4:0:22
...
//}
//ubo int UserUniforms 0:33:4400 {
...
//float4 Tweak_N1Size 4176
//float4 Tweak_N1Dims 4192
//float4 Tweak_N1View 4208
//float3x3 Tweak_N1Transform 4224
//float4 Tweak_N1UvMinMax 4272
//float4 Tweak_N1BorderColor 4288
...
//spec_const bool SC_USE_CLAMP_TO_BORDER_Tweak_N1 31
//spec_const bool SC_USE_CLAMP_TO_BORDER_intensityTexture 32
//spec_const bool SC_USE_UV_MIN_MAX_Tweak_N1 33
//spec_const bool SC_USE_UV_MIN_MAX_intensityTexture 34
//spec_const bool SC_USE_UV_TRANSFORM_Tweak_N1 35
//spec_const bool SC_USE_UV_TRANSFORM_intensityTexture 36
//spec_const bool Tweak_N1HasSwappedViews 37
...
//spec_const int SC_DEVICE_CLASS 70
//spec_const int SC_SOFTWARE_WRAP_MODE_U_Tweak_N1 71
//spec_const int SC_SOFTWARE_WRAP_MODE_U_intensityTexture 72
//spec_const int SC_SOFTWARE_WRAP_MODE_V_Tweak_N1 73
//spec_const int SC_SOFTWARE_WRAP_MODE_V_intensityTexture 74
//spec_const int Tweak_N1Layout 75
...
constant bool SC_USE_CLAMP_TO_BORDER_Tweak_N1 [[function_constant(31)]];
...
constant bool SC_USE_UV_MIN_MAX_Tweak_N1 [[function_constant(33)]];
...
constant bool SC_USE_UV_TRANSFORM_Tweak_N1 [[function_constant(35)]];
...
constant bool Tweak_N1HasSwappedViews [[function_constant(37)]];
...
constant int SC_SOFTWARE_WRAP_MODE_U_Tweak_N1 [[function_constant(71)]];
...
constant int SC_SOFTWARE_WRAP_MODE_V_Tweak_N1 [[function_constant(73)]];
...
constant int Tweak_N1Layout [[function_constant(75)]];
...
Value_N52=(*sc_set0.UserUniforms).Port_Import_N052;
...
Output_N58=Output_N57*(*sc_set0.UserUniforms).Port_Input1_N058;
...
Output_N70=Value3_N67+(*sc_set0.UserUniforms).Port_Input1_N070;
...
Output_N75=Output_N74*(*sc_set0.UserUniforms).Port_Input1_N075;
float2 Output_N76=float2(0.0);
Output_N76=Output_N66/float2(Output_N75);
float2 Output_N83=float2(0.0);
Output_N83=Output_N76+(*sc_set0.UserUniforms).Port_Input1_N083;
...
float3x3 param_11=(*sc_set0.UserUniforms).Tweak_N1Transform;
...
float4 param_14=(*sc_set0.UserUniforms).Tweak_N1UvMinMax;
bool param_15=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N1_tmp)!=0);
float4 param_16=(*sc_set0.UserUniforms).Tweak_N1BorderColor;
float param_17=0.0;
...
float l9_86=l9_78;
float4 l9_87=sc_set0.Tweak_N1.sample(sc_set0.Tweak_N1SmpSC,l9_85,bias(l9_86));
float4 l9_88=l9_87;
float4 l9_89=l9_88;
if (param_15)
{
...
{
if (param_23<(*sc_set0.UserUniforms).alphaTestThreshold)
{
discard_fragment();
}
}
...
if (sc_ShaderCacheConstant_tmp!=0)
{
param_25.x+=((*sc_set0.UserUniforms).sc_UniformConstants.x*float(sc_ShaderCacheConstant_tmp));
}
...
FinalColor=outputMotionVectorsIfNeeded(param_27,param_28,in.varStereoViewID,(*sc_set0.UserUniforms));
