...
//sampler sampler Tweak_N1SmpSC 0:16
...
//texture texture2D Tweak_N1 0:0:0:16
...
vec2 l9_13=(vec2(1.0)-((vec2(l9_7,l9_8)/vec2(l9_12))+Port_Input1_N083))+vec2(Port_Import_N059,Port_Import_N060);
int l9_14;
...
#endif
float l9_15=l9_13.x;
sc_SoftwareWrapEarly(l9_15,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N1,SC_SOFTWARE_WRAP_MODE_V_Tweak_N1).x);
float l9_16=l9_15;
float l9_17=l9_13.y;
sc_SoftwareWrapEarly(l9_17,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N1,SC_SOFTWARE_WRAP_MODE_V_Tweak_N1).y);
float l9_18=l9_17;
vec2 l9_19;
float l9_20;
...
{
l9_21=ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N1,SC_SOFTWARE_WRAP_MODE_V_Tweak_N1).x==3;
}
#else
{
...
float l9_22=l9_16;
float l9_23=1.0;
sc_ClampUV(l9_22,Tweak_N1UvMinMax.x,Tweak_N1UvMinMax.z,l9_21,l9_23);
float l9_24=l9_22;
float l9_25=l9_23;
bool l9_26;
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N1)
{
l9_26=ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N1,SC_SOFTWARE_WRAP_MODE_V_Tweak_N1).y==3;
}
#else
{
l9_26=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N1)!=0);
}
#endif
float l9_27=l9_18;
float l9_28=l9_25;
sc_ClampUV(l9_27,Tweak_N1UvMinMax.y,Tweak_N1UvMinMax.w,l9_26,l9_28);
l9_20=l9_28;
...
#endif
vec2 l9_29=sc_TransformUV(l9_19,(int(SC_USE_UV_TRANSFORM_Tweak_N1)!=0),Tweak_N1Transform);
float l9_30=l9_29.x;
float l9_31=l9_20;
sc_SoftwareWrapLate(l9_30,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N1,SC_SOFTWARE_WRAP_MODE_V_Tweak_N1).x,(int(SC_USE_CLAMP_TO_BORDER_Tweak_N1)!=0)&&(!(int(SC_USE_UV_MIN_MAX_Tweak_N1)!=0)),l9_31);
float l9_32=l9_29.y;
float l9_33=l9_31;
sc_SoftwareWrapLate(l9_32,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N1,SC_SOFTWARE_WRAP_MODE_V_Tweak_N1).y,(int(SC_USE_CLAMP_TO_BORDER_Tweak_N1)!=0)&&(!(int(SC_USE_UV_MIN_MAX_Tweak_N1)!=0)),l9_33);
float l9_34=l9_33;
vec3 l9_35=sc_SamplingCoordsViewToGlobal(vec2(l9_30,l9_32),Tweak_N1Layout,l9_14);
vec4 l9_36=texture2D(Tweak_N1,l9_35.xy,0.0);
vec4 l9_37;
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N1)
{
l9_37=mix(Tweak_N1BorderColor,l9_36,vec4(l9_34));
}
#else
{
l9_37=l9_36;
...
{
l9_38=vec4(pow(l9_37.x,2.2),pow(l9_37.y,2.2),pow(l9_37.z,2.2),0.0);
}
#else
{
l9_38=l9_37*l9_37;
...
#endif
vec3 l9_39=vec3(Port_Import_N062)*l9_38.xyz;
vec3 l9_40;
#if ((SC_DEVICE_CLASS>=2)&&SC_GL_FRAGMENT_PRECISION_HIGH)
{
l9_40=vec3(pow(l9_39.x,0.45454544),pow(l9_39.y,0.45454544),pow(l9_39.z,0.45454544));
}
#else
{
l9_40=sqrt(l9_39);
...
#endif
vec3 l9_41=mix(baseColor.xyz,min(baseColor.xyz+l9_40.xyz,vec3(1.0)).xyz,vec3(Port_Value2_N003));
...
{
l9_45=clamp(baseColor.w*2.0,0.0,1.0);
}
#else
{
float l9_46;
...
{
l9_46=clamp(dot(l9_42.xyz,vec3(baseColor.w)),0.0,1.0);
}
#else
{
float l9_47;
...
{
l9_48=(1.0-dot(l9_42.xyz,vec3(0.33333001)))*baseColor.w;
}
#else
{
float l9_49;
...
{
l9_49=(1.0-clamp(dot(l9_42.xyz,vec3(1.0)),0.0,1.0))*baseColor.w;
}
#else
{
float l9_50;
...
{
l9_50=clamp(dot(l9_42.xyz,vec3(1.0)),0.0,1.0)*baseColor.w;
}
#else
{
float l9_51;
...
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_52=clamp(dot(l9_42.xyz,vec3(1.0)),0.0,1.0)*baseColor.w;
}
#else
{
float l9_53;
...
{
l9_53=dot(l9_42.xyz,vec3(0.33333001))*baseColor.w;
}
#else
{
float l9_54;
...
#if (sc_FramebufferFetch)
{
vec4 l9_59=sc_readFragData0_Platform();
vec4 l9_60;
#if (sc_UseFramebufferFetchMarker)
{
vec4 l9_61=l9_59;
l9_61.x=l9_59.x+_sc_framebufferFetchMarker;
l9_60=l9_61;
}
#else
{
...
#endif
l9_58=texture2D(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_62,sc_ScreenTextureLayout,l9_63).xy,0.0);
}
#endif
vec4 l9_64;
...
{
vec4 l9_65=l9_58;
l9_65.x=l9_58.x+_sc_GetFramebufferColorInvalidUsageMarker;
l9_64=l9_65;
}
#else
{
...
#endif
vec3 l9_66=mix(l9_64.xyz,definedBlend(l9_64.xyz,l9_42.xyz).xyz,vec3(baseColor.w));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_68=vec4(mix(vec3(1.0),l9_42.xyz,vec3(baseColor.w)),baseColor.w);
}
#else
{
vec4 l9_69;
...
{
l9_70=clamp(baseColor.w,0.0,1.0);
}
#else
{
l9_70=baseColor.w;
...
#endif
l9_69=vec4(l9_42.xyz*l9_70,l9_70);
}
#else
{
l9_69=l9_42;
...
{
l9_73=vec4(shaderComplexityValue/255.0,0.0,0.0,1.0);
}
#else
{
l9_73=vec4(0.0);
...
vec4 l9_75=outputMotionVectorsIfNeeded(varPos,max(l9_74,vec4(0.0)));
vec4 l9_76=clamp(l9_75,vec4(0.0),vec4(1.0));
#if (sc_OITDepthBoundsPass)
{
#if (sc_OITDepthBoundsPass)
{
float l9_77=clamp(viewSpaceDepth()/1000.0,0.0,1.0);
sc_writeFragData0(vec4(max(0.0,1.0-(l9_77-0.0039215689)),min(1.0,l9_77+0.0039215689),0.0,0.0));
}
#endif
}
#else
...
#if (sc_OITDepthGatherPass)
{
vec2 l9_78=sc_ScreenCoordsGlobalToView(gl_FragCoord.xy*sc_CurrentRenderTargetDims.zw);
...
#endif
int l9_79=encodeDepth(viewSpaceDepth(),texture2D(sc_OITFilteredDepthBoundsTexture,l9_78).xy);
float l9_80=packValue(l9_79);
int l9_87=int(l9_76.w*255.0);
float l9_88=packValue(l9_87);
sc_writeFragData0(vec4(packValue(l9_79),packValue(l9_79),packValue(l9_79),packValue(l9_79)));
sc_writeFragData1(vec4(l9_80,packValue(l9_79),packValue(l9_79),packValue(l9_79)));
sc_writeFragData2(vec4(l9_88,packValue(l9_87),packValue(l9_87),packValue(l9_87)));
...
#if (sc_OITMaxLayers4Plus1)
{
if ((gl_FragCoord.z-texture2D(sc_OITFrontDepthTexture,l9_91).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
...
if (l9_96==0)
{
l9_99=texture2D(sc_OITAlpha0,l9_91);
l9_98=texture2D(sc_OITDepthLow0,l9_91);
l9_97=texture2D(sc_OITDepthHigh0,l9_91);
}
else
{
l9_99=vec4(0.0);
...
if (l9_96==1)
{
l9_102=texture2D(sc_OITAlpha1,l9_91);
l9_101=texture2D(sc_OITDepthLow1,l9_91);
l9_100=texture2D(sc_OITDepthHigh1,l9_91);
}
else
{
l9_102=l9_99;
...
if (any(notEqual(l9_100,vec4(0.0)))||any(notEqual(l9_101,vec4(0.0))))
{
int l9_103[8]=l9_92;
unpackValues(l9_100.w,l9_96,l9_103);
unpackValues(l9_100.z,l9_96,l9_103);
unpackValues(l9_100.y,l9_96,l9_103);
unpackValues(l9_100.x,l9_96,l9_103);
unpackValues(l9_101.w,l9_96,l9_103);
unpackValues(l9_101.z,l9_96,l9_103);
unpackValues(l9_101.y,l9_96,l9_103);
unpackValues(l9_101.x,l9_96,l9_103);
int l9_112[8]=l9_93;
unpackValues(l9_102.w,l9_96,l9_112);
unpackValues(l9_102.z,l9_96,l9_112);
unpackValues(l9_102.y,l9_96,l9_112);
unpackValues(l9_102.x,l9_96,l9_112);
}
l9_96++;
continue;
}
...
vec4 l9_117=texture2D(sc_OITFilteredDepthBoundsTexture,l9_91);
vec2 l9_118=l9_117.xy;
int l9_119;
#if (sc_SkinBonesCount>0)
{
l9_119=encodeDepth(((1.0-l9_117.x)*1000.0)+getDepthOrderingEpsilon(),l9_118);
}
#else
{
l9_119=0;
...
#endif
int l9_120=encodeDepth(viewSpaceDepth(),l9_118);
vec4 l9_121;
l9_121=l9_76*l9_76.w;
vec4 l9_122;
int l9_123=0;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_123<8)
{
int l9_124=l9_92[l9_123];
int l9_125=l9_120-l9_119;
bool l9_126=l9_124<l9_125;
bool l9_127;
if (l9_126)
{
l9_127=l9_92[l9_123]>0;
}
else
{
l9_127=l9_126;
...
if (l9_127)
{
vec3 l9_128=l9_121.xyz*(1.0-(float(l9_93[l9_123])/255.0));
l9_122=vec4(l9_128.x,l9_128.y,l9_128.z,l9_121.w);
}
else
{
l9_122=l9_121;
