...
//sampler sampler notification_outline_maskSmpSC 0:23
...
//texture texture2D notification_outline_mask 0:5:0:23
...
//}
//ubo int UserUniforms 0:33:4768 {
...
//float notification_tile_lightness 4148
//float notification_outline_lightness 4152
//float4 notification_outline_maskSize 4160
//float4 notification_outline_maskDims 4176
//float4 notification_outline_maskView 4192
//float3x3 notification_outline_maskTransform 4208
//float4 notification_outline_maskUvMinMax 4256
//float4 notification_outline_maskBorderColor 4272
//float Tweak_N12 4288
//float notification_tile_opacity 4292
//float Port_Input1_N018 4296
//float Port_Input1_N021 4300
//float4 Port_Import_N038 4304
//float4 Port_Import_N039 4320
//float Port_Input0_N066 4336
//float Port_Input1_N066 4340
//float Port_RangeMinA_N033 4344
//float Port_RangeMaxA_N033 4348
//float Port_RangeMinB_N033 4352
//float Port_RangeMaxB_N033 4356
//float2 Port_Import_N025 4360
//float2 Port_Center_N047 4368
//float2 Port_Import_N058 4376
//float2 Port_Import_N060 4384
//float Port_Input1_N065 4392
//float Port_Input2_N065 4396
//float2 Port_Offset_N003 4400
//float Port_Rotation_N007 4408
//float2 Port_Center_N007 4416
//float4 Port_Value0_N001 4432
//float Port_Position1_N001 4448
//float4 Port_Value1_N001 4464
//float Port_Position2_N001 4480
//float4 Port_Value2_N001 4496
//float4 Port_Value3_N001 4512
//float2 Port_Offset_N022 4528
//float Port_Rotation_N023 4536
//float2 Port_Center_N023 4544
//float3 Port_Value0_N000 4560
//float Port_Position1_N000 4576
//float3 Port_Value1_N000 4592
//float Port_Position2_N000 4608
//float3 Port_Value2_N000 4624
//float3 Port_Value3_N000 4640
//float4 Port_Import_N031 4656
//float4 Port_Import_N032 4672
//float Port_Input0_N049 4688
//float Port_Input1_N049 4692
//float Port_RangeMinA_N035 4696
//float Port_RangeMaxA_N035 4700
//float Port_RangeMinB_N035 4704
//float Port_RangeMaxB_N035 4708
//float2 Port_Import_N036 4712
//float2 Port_Center_N037 4720
//float2 Port_Import_N040 4728
//float2 Port_Import_N042 4736
//float Port_Input1_N048 4744
//float Port_Input2_N048 4748
//float Port_Mask_N030 4752
//float Port_Mask_N053 4756
//float depthRef 4760
//}
...
//spec_const bool SC_USE_CLAMP_TO_BORDER_notification_outline_mask 32
//spec_const bool SC_USE_UV_MIN_MAX_intensityTexture 33
//spec_const bool SC_USE_UV_MIN_MAX_notification_outline_mask 34
//spec_const bool SC_USE_UV_TRANSFORM_intensityTexture 35
//spec_const bool SC_USE_UV_TRANSFORM_notification_outline_mask 36
//spec_const bool UseViewSpaceDepthVariant 37
//spec_const bool intensityTextureHasSwappedViews 38
//spec_const bool notification_outline_maskHasSwappedViews 39
...
//spec_const int SC_SOFTWARE_WRAP_MODE_U_notification_outline_mask 71
//spec_const int SC_SOFTWARE_WRAP_MODE_V_intensityTexture 72
//spec_const int SC_SOFTWARE_WRAP_MODE_V_notification_outline_mask 73
//spec_const int intensityTextureLayout 74
//spec_const int notification_outline_maskLayout 75
...
constant bool SC_USE_CLAMP_TO_BORDER_notification_outline_mask [[function_constant(32)]];
...
constant bool SC_USE_UV_MIN_MAX_notification_outline_mask [[function_constant(34)]];
...
constant bool SC_USE_UV_TRANSFORM_notification_outline_mask [[function_constant(36)]];
...
constant bool notification_outline_maskHasSwappedViews [[function_constant(39)]];
...
constant int SC_SOFTWARE_WRAP_MODE_U_notification_outline_mask [[function_constant(71)]];
...
constant int SC_SOFTWARE_WRAP_MODE_V_notification_outline_mask [[function_constant(73)]];
...
constant int notification_outline_maskLayout [[function_constant(75)]];
...
Output_N18=Value1_N17*(*sc_set0.UserUniforms).Port_Input1_N018;
float Output_N21=0.0;
Output_N21=Output_N18+(*sc_set0.UserUniforms).Port_Input1_N021;
float4 Value_N38=float4(0.0);
Value_N38=(*sc_set0.UserUniforms).Port_Import_N038;
float4 Value_N39=float4(0.0);
Value_N39=(*sc_set0.UserUniforms).Port_Import_N039;
float2 UVCoord_N119=float2(0.0);
UVCoord_N119=Globals.Surface_UVCoord0;
float2 ValueOut_N33=float2(0.0);
ValueOut_N33=(((UVCoord_N119-float2((*sc_set0.UserUniforms).Port_RangeMinA_N033))/float2((*sc_set0.UserUniforms).Port_RangeMaxA_N033-(*sc_set0.UserUniforms).Port_RangeMinA_N033))*((*sc_set0.UserUniforms).Port_RangeMaxB_N033-(*sc_set0.UserUniforms).Port_RangeMinB_N033))+float2((*sc_set0.UserUniforms).Port_RangeMinB_N033);
float2 Value_N25=float2(0.0);
Value_N25=(*sc_set0.UserUniforms).Port_Import_N025;
float2 CoordsOut_N47=float2(0.0);
CoordsOut_N47=((ValueOut_N33-(*sc_set0.UserUniforms).Port_Center_N047)*Value_N25)+(*sc_set0.UserUniforms).Port_Center_N047;
float2 Value_N58=float2(0.0);
Value_N58=(*sc_set0.UserUniforms).Port_Import_N058;
float2 Output_N59=float2(0.0);
Output_N59=CoordsOut_N47-Value_N58;
float2 Value_N60=float2(0.0);
Value_N60=(*sc_set0.UserUniforms).Port_Import_N060;
...
Output_N66=smoothstep((*sc_set0.UserUniforms).Port_Input0_N066,(*sc_set0.UserUniforms).Port_Input1_N066,Output_N65);
...
CoordsOut_N3=Output_N26.xy+(*sc_set0.UserUniforms).Port_Offset_N003;
float2 CoordsOut_N7=float2(0.0);
float2 param_2=CoordsOut_N3;
float param_3=(*sc_set0.UserUniforms).Port_Rotation_N007;
float2 param_4=(*sc_set0.UserUniforms).Port_Center_N007;
...
float4 param_7=(*sc_set0.UserUniforms).Port_Value0_N001;
float param_8=(*sc_set0.UserUniforms).Port_Position1_N001;
float4 param_9=(*sc_set0.UserUniforms).Port_Value1_N001;
float param_10=(*sc_set0.UserUniforms).Port_Position2_N001;
float4 param_11=(*sc_set0.UserUniforms).Port_Value2_N001;
float4 param_12=(*sc_set0.UserUniforms).Port_Value3_N001;
...
bool l9_9=(*sc_set0.UserUniforms).PreviewEnabled==1;
bool l9_10;
if (l9_9)
{
...
if (l9_10)
{
l9_11=1==(*sc_set0.UserUniforms).PreviewNodeID;
}
else
{
l9_11=l9_10;
...
float param_14=(*sc_set0.UserUniforms).notification_tile_lightness;
Output_N27=param_14;
...
CoordsOut_N22=UVCoord_N2+(*sc_set0.UserUniforms).Port_Offset_N022;
float2 CoordsOut_N23=float2(0.0);
float2 param_15=CoordsOut_N22;
float param_16=(*sc_set0.UserUniforms).Port_Rotation_N023;
float2 param_17=(*sc_set0.UserUniforms).Port_Center_N023;
...
float3 param_20=(*sc_set0.UserUniforms).Port_Value0_N000;
float param_21=(*sc_set0.UserUniforms).Port_Position1_N000;
float3 param_22=(*sc_set0.UserUniforms).Port_Value1_N000;
float param_23=(*sc_set0.UserUniforms).Port_Position2_N000;
float3 param_24=(*sc_set0.UserUniforms).Port_Value2_N000;
float3 param_25=(*sc_set0.UserUniforms).Port_Value3_N000;
...
bool l9_14=(*sc_set0.UserUniforms).PreviewEnabled==1;
bool l9_15;
if (l9_14)
{
...
if (l9_15)
{
l9_16=0==(*sc_set0.UserUniforms).PreviewNodeID;
}
else
{
l9_16=l9_15;
...
Value_N0=param_26;
float Output_N5=0.0;
float param_27=(*sc_set0.UserUniforms).notification_outline_lightness;
Output_N5=param_27;
...
float3x3 param_32=(*sc_set0.UserUniforms).notification_outline_maskTransform;
...
float4 param_35=(*sc_set0.UserUniforms).notification_outline_maskUvMinMax;
bool param_36=(int(SC_USE_CLAMP_TO_BORDER_notification_outline_mask_tmp)!=0);
float4 param_37=(*sc_set0.UserUniforms).notification_outline_maskBorderColor;
float param_38=0.0;
...
float l9_92=l9_84;
float4 l9_93=sc_set0.notification_outline_mask.sample(sc_set0.notification_outline_maskSmpSC,l9_91,bias(l9_92));
float4 l9_94=l9_93;
float4 l9_95=l9_94;
if (param_36)
{
...
Value_N32=(*sc_set0.UserUniforms).Port_Import_N032;
float2 UVCoord_N34=float2(0.0);
UVCoord_N34=Globals.Surface_UVCoord0;
float2 ValueOut_N35=float2(0.0);
ValueOut_N35=(((UVCoord_N34-float2((*sc_set0.UserUniforms).Port_RangeMinA_N035))/float2((*sc_set0.UserUniforms).Port_RangeMaxA_N035-(*sc_set0.UserUniforms).Port_RangeMinA_N035))*((*sc_set0.UserUniforms).Port_RangeMaxB_N035-(*sc_set0.UserUniforms).Port_RangeMinB_N035))+float2((*sc_set0.UserUniforms).Port_RangeMinB_N035);
float2 Value_N36=float2(0.0);
Value_N36=(*sc_set0.UserUniforms).Port_Import_N036;
float2 CoordsOut_N37=float2(0.0);
CoordsOut_N37=((ValueOut_N35-(*sc_set0.UserUniforms).Port_Center_N037)*Value_N36)+(*sc_set0.UserUniforms).Port_Center_N037;
float2 Value_N40=float2(0.0);
Value_N40=(*sc_set0.UserUniforms).Port_Import_N040;
float2 Output_N41=float2(0.0);
Output_N41=CoordsOut_N37-Value_N40;
float2 Value_N42=float2(0.0);
Value_N42=(*sc_set0.UserUniforms).Port_Import_N042;
...
Output_N48=fast::clamp(Output_N46+0.001,(*sc_set0.UserUniforms).Port_Input1_N048+0.001,(*sc_set0.UserUniforms).Port_Input2_N048+0.001)-0.001;
float Output_N49=0.0;
Output_N49=smoothstep((*sc_set0.UserUniforms).Port_Input0_N049,(*sc_set0.UserUniforms).Port_Input1_N049,Output_N48);
...
float param_39=(*sc_set0.UserUniforms).Tweak_N12;
Output_N12=param_39;
float4 Output_N29=float4(0.0);
Output_N29=Color_N11*float4(Output_N12);
float Output_N8=0.0;
float param_40=(*sc_set0.UserUniforms).notification_tile_opacity;
Output_N8=param_40;
...
bool l9_106=(*sc_set0.UserUniforms).isProxyMode!=0;
if (l9_106)
{
...
float l9_111=l9_110;
float l9_112=l9_111;
float l9_113=(*sc_set0.UserUniforms).sc_ShadowDensity*l9_112;
float3 l9_114=mix((*sc_set0.UserUniforms).sc_ShadowColor.xyz,(*sc_set0.UserUniforms).sc_ShadowColor.xyz*l9_108.xyz,float3((*sc_set0.UserUniforms).sc_ShadowColor.w));
...
{
l9_120.x+=(*sc_set0.UserUniforms)._sc_framebufferFetchMarker;
}
...
float2 l9_123=l9_122.xy*(*sc_set0.UserUniforms).sc_CurrentRenderTargetDims.zw;
...
float l9_160=l9_152;
float4 l9_161=sc_set0.sc_ScreenTexture.sample(sc_set0.sc_ScreenTextureSmpSC,l9_159,bias(l9_160));
...
float3 l9_171=definedBlend(l9_169,l9_170,in.varStereoViewID,(*sc_set0.UserUniforms),sc_set0.intensityTexture,sc_set0.intensityTextureSmpSC);
...
{
l9_179=float4((*sc_set0.UserUniforms).shaderComplexityValue/255.0,0.0,0.0,1.0);
}
else
{
l9_179=float4(0.0);
...
FinalColor=outputMotionVectorsIfNeeded(param_51,param_52,in.varStereoViewID,(*sc_set0.UserUniforms));
float4 param_53=FinalColor;
float4 l9_181=param_53;
if (sc_ShaderCacheConstant_tmp!=0)
{
l9_181.x+=((*sc_set0.UserUniforms).sc_UniformConstants.x*float(sc_ShaderCacheConstant_tmp));
}
