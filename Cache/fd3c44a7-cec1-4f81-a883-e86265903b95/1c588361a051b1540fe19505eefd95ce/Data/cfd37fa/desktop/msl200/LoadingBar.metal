...
//sampler sampler Tweak_N3SmpSC 0:22
...
//texture texture2D Tweak_N3 0:4:0:22
...
//float Tweak_N79 4148
//float4 Tweak_N3Size 4160
//float4 Tweak_N3Dims 4176
//float4 Tweak_N3View 4192
//float3x3 Tweak_N3Transform 4208
//float4 Tweak_N3UvMinMax 4256
//float4 Tweak_N3BorderColor 4272
//float Tweak_N1 4288
//float Tweak_N8 4292
//float alpha 4296
//float4 Port_Input0_N123 4304
//float Port_Import_N062 4320
//float3 Port_Import_N052 4336
//float3 Port_Input1_N058 4352
//float3 Port_Import_N065 4368
//float Port_Input1_N070 4384
//float Port_Input1_N075 4388
//float2 Port_Input1_N083 4392
//float Port_Import_N059 4400
//float Port_Import_N060 4404
//float Port_Value2_N006 4408
//float4 Port_Import_N092 4416
//float Port_Import_N096 4432
//float4 Port_Input1_N119 4448
//float Port_Import_N120 4464
//float Port_Import_N122 4468
//float3 Port_Normal_N041 4480
//float depthRef 4496
//}
...
//spec_const bool SC_USE_CLAMP_TO_BORDER_Tweak_N3 31
//spec_const bool SC_USE_CLAMP_TO_BORDER_intensityTexture 32
//spec_const bool SC_USE_UV_MIN_MAX_Tweak_N3 33
//spec_const bool SC_USE_UV_MIN_MAX_intensityTexture 34
//spec_const bool SC_USE_UV_TRANSFORM_Tweak_N3 35
//spec_const bool SC_USE_UV_TRANSFORM_intensityTexture 36
//spec_const bool Tweak_N3HasSwappedViews 37
...
//spec_const int SC_SOFTWARE_WRAP_MODE_U_Tweak_N3 71
//spec_const int SC_SOFTWARE_WRAP_MODE_U_intensityTexture 72
//spec_const int SC_SOFTWARE_WRAP_MODE_V_Tweak_N3 73
//spec_const int SC_SOFTWARE_WRAP_MODE_V_intensityTexture 74
//spec_const int Tweak_N3Layout 75
...
constant bool SC_USE_CLAMP_TO_BORDER_Tweak_N3 [[function_constant(31)]];
...
constant bool SC_USE_UV_MIN_MAX_Tweak_N3 [[function_constant(33)]];
...
constant bool SC_USE_UV_TRANSFORM_Tweak_N3 [[function_constant(35)]];
...
constant bool Tweak_N3HasSwappedViews [[function_constant(37)]];
...
constant int SC_SOFTWARE_WRAP_MODE_U_Tweak_N3 [[function_constant(71)]];
...
constant int SC_SOFTWARE_WRAP_MODE_V_Tweak_N3 [[function_constant(73)]];
...
constant int Tweak_N3Layout [[function_constant(75)]];
...
float param=(*sc_set0.UserUniforms).Tweak_N79;
Output_N79=param;
float Value_N62=0.0;
...
float3x3 param_11=(*sc_set0.UserUniforms).Tweak_N3Transform;
...
float4 param_14=(*sc_set0.UserUniforms).Tweak_N3UvMinMax;
bool param_15=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N3_tmp)!=0);
float4 param_16=(*sc_set0.UserUniforms).Tweak_N3BorderColor;
float param_17=0.0;
...
float l9_86=l9_78;
float4 l9_87=sc_set0.Tweak_N3.sample(sc_set0.Tweak_N3SmpSC,l9_85,bias(l9_86));
float4 l9_88=l9_87;
float4 l9_89=l9_88;
if (param_15)
{
...
Value_N6.w=(*sc_set0.UserUniforms).Port_Value2_N006;
float4 Value_N92=float4(0.0);
Value_N92=Value_N6;
float Value_N96=0.0;
Value_N96=fast::clamp((*sc_set0.UserUniforms).Port_Import_N096,0.0,5.0);
float4 Output_N99=float4(0.0);
Output_N99=Value_N92*float4(Value_N96);
float Output_N119=0.0;
Output_N119=dot(Output_N99,(*sc_set0.UserUniforms).Port_Input1_N119);
float Value_N120=0.0;
Value_N120=fast::clamp((*sc_set0.UserUniforms).Port_Import_N120,0.0,2.0);
float4 Output_N121=float4(0.0);
Output_N121=mix(float4(Output_N119),Output_N99,float4(Value_N120));
float Value_N122=0.0;
Value_N122=fast::clamp((*sc_set0.UserUniforms).Port_Import_N122,0.0,2.0);
float4 Output_N123=float4(0.0);
Output_N123=mix((*sc_set0.UserUniforms).Port_Input0_N123,Output_N121,float4(Value_N122));
float4 Export_N124=float4(0.0);
Export_N124=Output_N123;
float Output_N1=0.0;
float param_20=(*sc_set0.UserUniforms).Tweak_N1;
Output_N1=param_20;
float Output_N8=0.0;
float param_21=(*sc_set0.UserUniforms).Tweak_N8;
Output_N8=param_21;
float Rim_N41=0.0;
float3 param_22=(*sc_set0.UserUniforms).Port_Normal_N041;
...
float param_30=(*sc_set0.UserUniforms).alpha;
