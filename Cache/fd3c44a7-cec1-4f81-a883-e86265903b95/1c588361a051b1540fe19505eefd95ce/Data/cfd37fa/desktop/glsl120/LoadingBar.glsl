...
//sampler sampler Tweak_N3SmpSC 0:16
...
//texture texture2D Tweak_N3 0:0:0:16
...
vec2 l9_15=(vec2(1.0)-((vec2(l9_9,l9_10)/vec2(l9_14))+Port_Input1_N083))+vec2(Port_Import_N059,Port_Import_N060);
int l9_16;
...
#endif
float l9_17=l9_15.x;
sc_SoftwareWrapEarly(l9_17,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N3,SC_SOFTWARE_WRAP_MODE_V_Tweak_N3).x);
float l9_18=l9_17;
float l9_19=l9_15.y;
sc_SoftwareWrapEarly(l9_19,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N3,SC_SOFTWARE_WRAP_MODE_V_Tweak_N3).y);
float l9_20=l9_19;
vec2 l9_21;
float l9_22;
#if (SC_USE_UV_MIN_MAX_Tweak_N3)
{
bool l9_23;
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N3)
{
l9_23=ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N3,SC_SOFTWARE_WRAP_MODE_V_Tweak_N3).x==3;
}
#else
{
l9_23=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N3)!=0);
}
#endif
float l9_24=l9_18;
float l9_25=1.0;
sc_ClampUV(l9_24,Tweak_N3UvMinMax.x,Tweak_N3UvMinMax.z,l9_23,l9_25);
float l9_26=l9_24;
float l9_27=l9_25;
bool l9_28;
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N3)
{
l9_28=ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N3,SC_SOFTWARE_WRAP_MODE_V_Tweak_N3).y==3;
}
#else
{
l9_28=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N3)!=0);
}
#endif
float l9_29=l9_20;
float l9_30=l9_27;
sc_ClampUV(l9_29,Tweak_N3UvMinMax.y,Tweak_N3UvMinMax.w,l9_28,l9_30);
l9_22=l9_30;
...
#endif
vec2 l9_31=sc_TransformUV(l9_21,(int(SC_USE_UV_TRANSFORM_Tweak_N3)!=0),Tweak_N3Transform);
float l9_32=l9_31.x;
float l9_33=l9_22;
sc_SoftwareWrapLate(l9_32,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N3,SC_SOFTWARE_WRAP_MODE_V_Tweak_N3).x,(int(SC_USE_CLAMP_TO_BORDER_Tweak_N3)!=0)&&(!(int(SC_USE_UV_MIN_MAX_Tweak_N3)!=0)),l9_33);
float l9_34=l9_31.y;
float l9_35=l9_33;
sc_SoftwareWrapLate(l9_34,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N3,SC_SOFTWARE_WRAP_MODE_V_Tweak_N3).y,(int(SC_USE_CLAMP_TO_BORDER_Tweak_N3)!=0)&&(!(int(SC_USE_UV_MIN_MAX_Tweak_N3)!=0)),l9_35);
float l9_36=l9_35;
vec3 l9_37=sc_SamplingCoordsViewToGlobal(vec2(l9_32,l9_34),Tweak_N3Layout,l9_16);
vec4 l9_38=texture2D(Tweak_N3,l9_37.xy,0.0);
vec4 l9_39;
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N3)
{
l9_39=mix(Tweak_N3BorderColor,l9_38,vec4(l9_36));
}
#else
{
l9_39=l9_38;
...
{
l9_40=vec4(pow(l9_39.x,2.2),pow(l9_39.y,2.2),pow(l9_39.z,2.2),0.0);
}
#else
{
l9_40=l9_39*l9_39;
...
#endif
vec3 l9_41=vec3(Tweak_N79)*l9_40.xyz;
vec3 l9_42;
#if ((SC_DEVICE_CLASS>=2)&&SC_GL_FRAGMENT_PRECISION_HIGH)
{
l9_42=vec3(pow(l9_41.x,0.45454544),pow(l9_41.y,0.45454544),pow(l9_41.z,0.45454544));
}
#else
{
l9_42=sqrt(l9_41);
...
#endif
vec4 l9_43=vec4(l9_42.x,l9_42.y,l9_42.z,vec4(0.0).w);
l9_43.w=Port_Value2_N006;
vec4 l9_44=l9_43*vec4(clamp(Port_Import_N096,0.0,5.0));
float l9_45=max(pow(1.0-abs(dot(-l9_0,l9_3*Port_Normal_N041)),Tweak_N1),0.0)*Tweak_N8;
vec3 l9_46=mix(Port_Input0_N123,mix(vec4(dot(l9_44,Port_Input1_N119)),l9_44,vec4(clamp(Port_Import_N120,0.0,2.0))),vec4(clamp(Port_Import_N122,0.0,2.0))).xyz;
vec3 l9_47=mix(l9_46,(vec3(1.0)-((vec3(1.0)-l9_46)*(vec3(1.0)-vec4(l9_45).xyz))).xyz,vec3(l9_45));
...
{
l9_52=clamp(dot(l9_48.xyz,vec3(alpha)),0.0,1.0);
}
#else
{
float l9_53;
...
{
l9_54=(1.0-dot(l9_48.xyz,vec3(0.33333001)))*alpha;
}
#else
{
float l9_55;
...
{
l9_55=(1.0-clamp(dot(l9_48.xyz,vec3(1.0)),0.0,1.0))*alpha;
}
#else
{
float l9_56;
...
{
l9_56=clamp(dot(l9_48.xyz,vec3(1.0)),0.0,1.0)*alpha;
}
#else
{
float l9_57;
#if (sc_BlendMode_Add)
{
l9_57=clamp(dot(l9_48.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_58;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_58=clamp(dot(l9_48.xyz,vec3(1.0)),0.0,1.0)*alpha;
}
#else
{
float l9_59;
...
{
l9_59=dot(l9_48.xyz,vec3(0.33333001))*alpha;
}
#else
{
float l9_60;
#if (sc_BlendMode_Min)
{
l9_60=1.0-clamp(dot(l9_48.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_61;
#if (sc_BlendMode_Max)
{
l9_61=clamp(dot(l9_48.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_61=1.0;
...
#endif
l9_49=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_48.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_50);
}
#else
{
vec4 l9_62;
...
#if (sc_FramebufferFetch)
{
vec4 l9_65=sc_readFragData0_Platform();
vec4 l9_66;
#if (sc_UseFramebufferFetchMarker)
{
vec4 l9_67=l9_65;
l9_67.x=l9_65.x+_sc_framebufferFetchMarker;
l9_66=l9_67;
}
#else
{
...
#else
{
vec2 l9_68=sc_ScreenCoordsGlobalToView(gl_FragCoord.xy*sc_CurrentRenderTargetDims.zw);
int l9_69;
...
#endif
l9_64=texture2D(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_68,sc_ScreenTextureLayout,l9_69).xy,0.0);
}
#endif
vec4 l9_70;
...
{
vec4 l9_71=l9_64;
l9_71.x=l9_64.x+_sc_GetFramebufferColorInvalidUsageMarker;
l9_70=l9_71;
}
#else
{
...
#endif
vec3 l9_72=mix(l9_70.xyz,definedBlend(l9_70.xyz,l9_48.xyz).xyz,vec3(alpha));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_74=vec4(mix(vec3(1.0),l9_48.xyz,vec3(alpha)),alpha);
}
#else
{
vec4 l9_75;
...
#endif
l9_75=vec4(l9_48.xyz*l9_76,l9_76);
}
#else
{
l9_75=l9_48;
...
#endif
int l9_85=encodeDepth(viewSpaceDepth(),texture2D(sc_OITFilteredDepthBoundsTexture,l9_84).xy);
...
#if (sc_OITMaxLayers4Plus1)
{
if ((gl_FragCoord.z-texture2D(sc_OITFrontDepthTexture,l9_97).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
...
if (l9_102==0)
{
l9_105=texture2D(sc_OITAlpha0,l9_97);
l9_104=texture2D(sc_OITDepthLow0,l9_97);
l9_103=texture2D(sc_OITDepthHigh0,l9_97);
}
else
{
l9_105=vec4(0.0);
...
if (l9_102==1)
{
l9_108=texture2D(sc_OITAlpha1,l9_97);
l9_107=texture2D(sc_OITDepthLow1,l9_97);
l9_106=texture2D(sc_OITDepthHigh1,l9_97);
}
else
{
l9_108=l9_105;
...
vec4 l9_123=texture2D(sc_OITFilteredDepthBoundsTexture,l9_97);
