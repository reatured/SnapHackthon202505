...
let Slider = class Slider extends BaseScriptComponent {
    ...
    get currentValue() {
        var _a, _b;
        return (_b = (_a = this.sliderState) === null || _a === void 0 ? void 0 : _a.displayValue) !== null && _b !== void 0 ? _b : null;
    }
    ...
    updateSliderState(dragUpdate) {
        ...
        if (this.sliderState.displayValue !== displayValue) {
            (_a = this.onValueUpdateEvent) === null || _a === void 0 ? void 0 : _a.invoke(displayValue);
        }
        this.sliderState = {
