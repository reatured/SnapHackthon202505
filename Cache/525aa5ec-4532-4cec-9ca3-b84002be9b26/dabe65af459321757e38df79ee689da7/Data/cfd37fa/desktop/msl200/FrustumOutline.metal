...
//}
//ubo int UserUniforms 0:35:4656 {
...
float param_9=(*sc_set0.UserUniforms).alpha;
Output_N127=param_9;
...
float4 l9_630=fast::max(param_11,float4(0.0));
float4 param_12=l9_630;
if (sc_ShaderCacheConstant_tmp!=0)
{
...
FinalColor=outputMotionVectorsIfNeeded(param_14,param_15,in.varStereoViewID,(*sc_set0.UserUniforms));
float4 param_16=FinalColor;
float4 l9_704=param_16;
if (sc_ShaderCacheConstant_tmp!=0)
{
