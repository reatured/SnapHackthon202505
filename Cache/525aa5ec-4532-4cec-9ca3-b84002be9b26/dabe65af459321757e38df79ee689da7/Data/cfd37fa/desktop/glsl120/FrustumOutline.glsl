...
float l9_31=l9_30.x;
float l9_32=l9_21;
sc_SoftwareWrapLate(l9_31,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex).x,(int(SC_USE_CLAMP_TO_BORDER_baseTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_baseTex)!=0)),l9_32);
float l9_33=l9_30.y;
float l9_34=l9_32;
sc_SoftwareWrapLate(l9_33,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex).y,(int(SC_USE_CLAMP_TO_BORDER_baseTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_baseTex)!=0)),l9_34);
float l9_35=l9_34;
vec3 l9_36=sc_SamplingCoordsViewToGlobal(vec2(l9_31,l9_33),baseTexLayout,l9_15);
...
{
vec2 l9_43;
Node122_If_else(0.0,vec2(0.0),vec2(0.0),l9_43,l9_5);
float l9_44;
Node67_Bool_Parameter(l9_44,l9_5);
...
{
vec2 l9_46;
Node64_If_else(0.0,vec2(0.0),vec2(0.0),l9_46,l9_5);
float l9_47;
Node11_Bool_Parameter(l9_47,l9_5);
...
float l9_64=l9_63.x;
float l9_65=l9_54;
sc_SoftwareWrapLate(l9_64,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).x,(int(SC_USE_CLAMP_TO_BORDER_opacityTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_opacityTex)!=0)),l9_65);
float l9_66=l9_63.y;
float l9_67=l9_65;
sc_SoftwareWrapLate(l9_66,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).y,(int(SC_USE_CLAMP_TO_BORDER_opacityTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_opacityTex)!=0)),l9_67);
}
#else
{
}
#endif
vec4 l9_68=vec4(l9_39.x,l9_39.y,l9_39.z,vec4(0.0).w);
l9_68.w=alpha;
...
{
l9_72=clamp(dot(l9_68.xyz,vec3(alpha)),0.0,1.0);
}
#else
{
float l9_73;
...
{
l9_74=(1.0-dot(l9_68.xyz,vec3(0.33333001)))*alpha;
}
#else
{
float l9_75;
...
{
l9_75=(1.0-clamp(dot(l9_68.xyz,vec3(1.0)),0.0,1.0))*alpha;
}
#else
{
float l9_76;
...
{
l9_76=clamp(dot(l9_68.xyz,vec3(1.0)),0.0,1.0)*alpha;
}
#else
{
float l9_77;
#if (sc_BlendMode_Add)
{
l9_77=clamp(dot(l9_68.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_78;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_78=clamp(dot(l9_68.xyz,vec3(1.0)),0.0,1.0)*alpha;
}
#else
{
float l9_79;
...
{
l9_79=dot(l9_68.xyz,vec3(0.33333001))*alpha;
}
#else
{
float l9_80;
#if (sc_BlendMode_Min)
{
l9_80=1.0-clamp(dot(l9_68.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_81;
#if (sc_BlendMode_Max)
{
l9_81=clamp(dot(l9_68.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_81=1.0;
...
#endif
l9_69=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_68.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_70);
}
#else
{
vec4 l9_82;
...
#if (sc_FramebufferFetch)
{
vec4 l9_85=sc_readFragData0_Platform();
vec4 l9_86;
#if (sc_UseFramebufferFetchMarker)
{
vec4 l9_87=l9_85;
l9_87.x=l9_85.x+_sc_framebufferFetchMarker;
l9_86=l9_87;
}
#else
{
...
#else
{
vec2 l9_88=sc_ScreenCoordsGlobalToView(l9_3);
int l9_89;
#if (sc_ScreenTextureHasSwappedViews)
{
l9_89=1-sc_GetStereoViewIndex();
}
#else
{
l9_89=sc_GetStereoViewIndex();
}
#endif
l9_84=texture2D(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_88,sc_ScreenTextureLayout,l9_89).xy,0.0);
}
#endif
vec4 l9_90;
...
{
vec4 l9_91=l9_84;
l9_91.x=l9_84.x+_sc_GetFramebufferColorInvalidUsageMarker;
l9_90=l9_91;
}
#else
{
...
#endif
vec3 l9_92=mix(l9_90.xyz,definedBlend(l9_90.xyz,l9_68.xyz).xyz,vec3(alpha));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_94=vec4(mix(vec3(1.0),l9_68.xyz,vec3(alpha)),alpha);
}
#else
{
vec4 l9_95;
...
#endif
l9_95=vec4(l9_68.xyz*l9_96,l9_96);
}
#else
{
l9_95=l9_68;
...
{
l9_99=vec4(shaderComplexityValue/255.0,0.0,0.0,1.0);
}
#else
{
l9_99=vec4(0.0);
...
vec4 l9_101=outputMotionVectorsIfNeeded(varPos,max(l9_100,vec4(0.0)));
...
sc_writeFragData0(vec4(max(0.0,1.0-(l9_103-0.0039215689)),min(1.0,l9_103+0.0039215689),0.0,0.0));
}
#endif
}
#else
...
#if (sc_OITDepthGatherPass)
{
vec2 l9_104=sc_ScreenCoordsGlobalToView(l9_3);
#if (sc_OITMaxLayers4Plus1)
{
if ((gl_FragCoord.z-texture2D(sc_OITFrontDepthTexture,l9_104).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
#endif
int l9_105=encodeDepth(viewSpaceDepth(),texture2D(sc_OITFilteredDepthBoundsTexture,l9_104).xy);
float l9_106=packValue(l9_105);
int l9_113=int(l9_102.w*255.0);
float l9_114=packValue(l9_113);
sc_writeFragData0(vec4(packValue(l9_105),packValue(l9_105),packValue(l9_105),packValue(l9_105)));
...
#if (sc_OITCompositingPass)
{
vec2 l9_117=sc_ScreenCoordsGlobalToView(l9_3);
#if (sc_OITMaxLayers4Plus1)
{
if ((gl_FragCoord.z-texture2D(sc_OITFrontDepthTexture,l9_117).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
...
if (l9_122==0)
{
l9_125=texture2D(sc_OITAlpha0,l9_117);
l9_124=texture2D(sc_OITDepthLow0,l9_117);
l9_123=texture2D(sc_OITDepthHigh0,l9_117);
}
else
{
l9_125=vec4(0.0);
...
if (l9_122==1)
{
l9_128=texture2D(sc_OITAlpha1,l9_117);
l9_127=texture2D(sc_OITDepthLow1,l9_117);
l9_126=texture2D(sc_OITDepthHigh1,l9_117);
}
else
{
l9_128=l9_125;
...
vec4 l9_143=texture2D(sc_OITFilteredDepthBoundsTexture,l9_117);
