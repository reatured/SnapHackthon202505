...
//float notification_tile_opacity 4288
//float Port_Input1_N018 4292
//float Port_Input1_N021 4296
...
Value_N14.w=(*sc_set0.UserUniforms).Port_Value2_N014;
float Output_N8=0.0;
float param_39=(*sc_set0.UserUniforms).notification_tile_opacity;
Output_N8=param_39;
...
{
if (param_40<(*sc_set0.UserUniforms).alphaTestThreshold)
{
discard_fragment();
}
}
...
bool l9_100=(*sc_set0.UserUniforms).isProxyMode!=0;
if (l9_100)
{
...
float l9_105=l9_104;
float l9_106=l9_105;
float l9_107=(*sc_set0.UserUniforms).sc_ShadowDensity*l9_106;
float3 l9_108=mix((*sc_set0.UserUniforms).sc_ShadowColor.xyz,(*sc_set0.UserUniforms).sc_ShadowColor.xyz*l9_102.xyz,float3((*sc_set0.UserUniforms).sc_ShadowColor.w));
...
{
l9_114.x+=(*sc_set0.UserUniforms)._sc_framebufferFetchMarker;
}
...
float2 l9_117=l9_116.xy*(*sc_set0.UserUniforms).sc_CurrentRenderTargetDims.zw;
...
float l9_154=l9_146;
float4 l9_155=sc_set0.sc_ScreenTexture.sample(sc_set0.sc_ScreenTextureSmpSC,l9_153,bias(l9_154));
...
float3 l9_165=definedBlend(l9_163,l9_164,in.varStereoViewID,(*sc_set0.UserUniforms),sc_set0.intensityTexture,sc_set0.intensityTextureSmpSC);
...
{
l9_173=float4((*sc_set0.UserUniforms).shaderComplexityValue/255.0,0.0,0.0,1.0);
}
else
{
l9_173=float4(0.0);
...
if (sc_ShaderCacheConstant_tmp!=0)
{
l9_175.x+=((*sc_set0.UserUniforms).sc_UniformConstants.x*float(sc_ShaderCacheConstant_tmp));
}
