...
class View {
    ...
    detachChild(child) {
        ...
        child.getSceneObject().removeParent();
        this.childViews.splice(index, 1);
        return true;
    }
    get config() {
    ...
    attachToParent(parent, preserveWorldTransform = false) {
        ...
        let parentSceneObject = parent instanceof View ? parent.getSceneObject() : parent;
    ...
    cascadeAttachToSceneCallbacks(parentDefaults = null, parentView = null) {
        ...
        let defaults = parentDefaults !== null && this._defaults !== null
