...
//sampler sampler handGlowTexSmpSC 0:22
...
//texture texture2D handGlowTex 0:4:0:22
...
//}
//ubo int UserUniforms 0:33:4368 {
...
//float4 indexGlowColor 4160
//float indexBrightness 4176
//float4 handGlowTexSize 4192
//float4 handGlowTexDims 4208
//float4 handGlowTexView 4224
//float3x3 handGlowTexTransform 4240
//float4 handGlowTexUvMinMax 4288
//float4 handGlowTexBorderColor 4304
//float4 thumbGlowColor 4320
//float thumbBrightness 4336
//float Port_Input0_N003 4340
//float Port_Input0_N011 4344
//float Port_Mask_N014 4348
//float depthRef 4352
//}
...
//spec_const int SC_SOFTWARE_WRAP_MODE_U_handGlowTex 70
//spec_const int SC_SOFTWARE_WRAP_MODE_U_intensityTexture 71
//spec_const int SC_SOFTWARE_WRAP_MODE_V_handGlowTex 72
//spec_const int SC_SOFTWARE_WRAP_MODE_V_intensityTexture 73
//spec_const int handGlowTexLayout 74
...
constant bool SC_USE_CLAMP_TO_BORDER_handGlowTex [[function_constant(31)]];
...
constant bool SC_USE_UV_MIN_MAX_handGlowTex [[function_constant(33)]];
...
constant bool SC_USE_UV_TRANSFORM_handGlowTex [[function_constant(35)]];
...
constant bool handGlowTexHasSwappedViews [[function_constant(38)]];
...
constant int SC_SOFTWARE_WRAP_MODE_U_handGlowTex [[function_constant(70)]];
...
constant int SC_SOFTWARE_WRAP_MODE_V_handGlowTex [[function_constant(72)]];
...
constant int handGlowTexLayout [[function_constant(74)]];
...
float4 indexGlowColor;
float indexBrightness;
...
float4 thumbGlowColor;
float thumbBrightness;
float Port_Input0_N003;
float Port_Input0_N011;
float Port_Mask_N014;
float depthRef;
};
struct sc_Bone_t
{
...
float4 param=(*sc_set0.UserUniforms).indexGlowColor;
Output_N6=param;
float Value1_N9=0.0;
float Value2_N9=0.0;
float Value3_N9=0.0;
float3 param_1=Output_N6.xyz;
float param_2=param_1.x;
float param_3=param_1.y;
float param_4=param_1.z;
Value1_N9=param_2;
Value2_N9=param_3;
Value3_N9=param_4;
float Output_N5=0.0;
float param_5=(*sc_set0.UserUniforms).indexBrightness;
Output_N5=param_5;
...
int l9_12=l9_7;
int param_6=handGlowTexLayout_tmp;
int param_7=l9_12;
float2 param_8=UVCoord_N0;
bool param_9=(int(SC_USE_UV_TRANSFORM_handGlowTex_tmp)!=0);
float3x3 param_10=(*sc_set0.UserUniforms).handGlowTexTransform;
int2 param_11=int2(SC_SOFTWARE_WRAP_MODE_U_handGlowTex_tmp,SC_SOFTWARE_WRAP_MODE_V_handGlowTex_tmp);
bool param_12=(int(SC_USE_UV_MIN_MAX_handGlowTex_tmp)!=0);
float4 param_13=(*sc_set0.UserUniforms).handGlowTexUvMinMax;
bool param_14=(int(SC_USE_CLAMP_TO_BORDER_handGlowTex_tmp)!=0);
float4 param_15=(*sc_set0.UserUniforms).handGlowTexBorderColor;
float param_16=0.0;
bool l9_13=param_14&&(!param_12);
float l9_14=1.0;
float l9_15=param_8.x;
int l9_16=param_11.x;
if (l9_16==1)
{
l9_15=fract(l9_15);
}
...
param_8.x=l9_15;
float l9_20=param_8.y;
int l9_21=param_11.y;
if (l9_21==1)
{
l9_20=fract(l9_20);
}
...
float l9_27=param_8.x;
float l9_28=param_13.x;
float l9_29=param_13.z;
bool l9_30=l9_26;
float l9_31=l9_14;
...
float l9_36=param_8.y;
float l9_37=param_13.y;
float l9_38=param_13.w;
bool l9_39=l9_35;
float l9_40=l9_14;
...
float2 l9_43=param_8;
bool l9_44=param_9;
float3x3 l9_45=param_10;
if (l9_44)
{
...
float2 l9_48=l9_47;
param_8=l9_48;
float l9_49=param_8.x;
int l9_50=param_11.x;
bool l9_51=l9_13;
float l9_52=l9_14;
if ((l9_50==0)||(l9_50==3))
{
...
param_8.x=l9_49;
l9_14=l9_52;
float l9_60=param_8.y;
int l9_61=param_11.y;
bool l9_62=l9_13;
float l9_63=l9_14;
if ((l9_61==0)||(l9_61==3))
{
...
param_8.y=l9_60;
l9_14=l9_63;
float2 l9_71=param_8;
int l9_72=param_6;
int l9_73=param_7;
float l9_74=param_16;
float2 l9_75=l9_71;
int l9_76=l9_72;
int l9_77=l9_73;
float3 l9_78=float3(0.0);
...
float l9_82=l9_74;
float4 l9_83=sc_set0.handGlowTex.sample(sc_set0.handGlowTexSmpSC,l9_81,bias(l9_82));
float4 l9_84=l9_83;
float4 l9_85=l9_84;
if (param_14)
{
l9_85=mix(param_15,l9_85,float4(l9_14));
}
float4 l9_86=l9_85;
Color_N1=l9_86;
float Output_N8=0.0;
Output_N8=Color_N1.x;
float Output_N3=0.0;
Output_N3=mix((*sc_set0.UserUniforms).Port_Input0_N003,Output_N5,Output_N8);
float4 Value_N7=float4(0.0);
Value_N7.x=Value1_N9;
Value_N7.y=Value2_N9;
Value_N7.z=Value3_N9;
Value_N7.w=Output_N3;
float4 Output_N15=float4(0.0);
float4 param_17=(*sc_set0.UserUniforms).thumbGlowColor;
Output_N15=param_17;
float Value1_N16=0.0;
float Value2_N16=0.0;
float Value3_N16=0.0;
float3 param_18=Output_N15.xyz;
float param_19=param_18.x;
float param_20=param_18.y;
float param_21=param_18.z;
Value1_N16=param_19;
Value2_N16=param_20;
Value3_N16=param_21;
float Output_N10=0.0;
float param_22=(*sc_set0.UserUniforms).thumbBrightness;
Output_N10=param_22;
float Output_N12=0.0;
Output_N12=Color_N1.y;
float Output_N11=0.0;
Output_N11=mix((*sc_set0.UserUniforms).Port_Input0_N011,Output_N10,Output_N12);
float4 Value_N17=float4(0.0);
Value_N17.x=Value1_N16;
Value_N17.y=Value2_N16;
Value_N17.z=Value3_N16;
Value_N17.w=Output_N11;
float4 Output_N14=float4(0.0);
float4 param_24=Value_N7;
float4 param_25=Value_N17;
float4 l9_87=param_24;
float4 l9_88=param_25;
float3 l9_89=l9_87.xyz*l9_87.w;
l9_87=float4(l9_89.x,l9_89.y,l9_89.z,l9_87.w);
float4 param_23=l9_87+(l9_88*(1.0-l9_87.w));
Output_N14=param_23;
...
bool l9_93=(*sc_set0.UserUniforms).isProxyMode!=0;
if (l9_93)
{
...
float4 l9_94=fast::max(param_27,float4(0.0));
float4 param_28=l9_94;
if (sc_ShaderCacheConstant_tmp!=0)
{
param_28.x+=((*sc_set0.UserUniforms).sc_UniformConstants.x*float(sc_ShaderCacheConstant_tmp));
}
...
float l9_98=l9_97;
float l9_99=l9_98;
float l9_100=(*sc_set0.UserUniforms).sc_ShadowDensity*l9_99;
float3 l9_101=mix((*sc_set0.UserUniforms).sc_ShadowColor.xyz,(*sc_set0.UserUniforms).sc_ShadowColor.xyz*l9_95.xyz,float3((*sc_set0.UserUniforms).sc_ShadowColor.w));
...
{
l9_107.x+=(*sc_set0.UserUniforms)._sc_framebufferFetchMarker;
}
...
float l9_147=l9_139;
float4 l9_148=sc_set0.sc_ScreenTexture.sample(sc_set0.sc_ScreenTextureSmpSC,l9_146,bias(l9_147));
...
float3 l9_158=definedBlend(l9_156,l9_157,in.varStereoViewID,(*sc_set0.UserUniforms),sc_set0.intensityTexture,sc_set0.intensityTextureSmpSC);
...
{
l9_166=float4((*sc_set0.UserUniforms).shaderComplexityValue/255.0,0.0,0.0,1.0);
}
else
{
l9_166=float4(0.0);
...
FinalColor=outputMotionVectorsIfNeeded(param_30,param_31,in.varStereoViewID,(*sc_set0.UserUniforms));
float4 param_32=FinalColor;
float4 l9_168=param_32;
if (sc_ShaderCacheConstant_tmp!=0)
{
l9_168.x+=((*sc_set0.UserUniforms).sc_UniformConstants.x*float(sc_ShaderCacheConstant_tmp));
}
