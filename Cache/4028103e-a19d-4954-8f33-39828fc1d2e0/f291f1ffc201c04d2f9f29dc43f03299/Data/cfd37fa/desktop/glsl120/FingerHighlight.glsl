...
//sampler sampler handGlowTexSmpSC 0:16
...
//texture texture2D handGlowTex 0:0:0:16
...
uniform vec4 indexGlowColor;
uniform float indexBrightness;
...
uniform vec4 thumbGlowColor;
uniform float thumbBrightness;
uniform float Port_Input0_N003;
uniform float Port_Input0_N011;
uniform float Port_Mask_N014;
...
sc_SoftwareWrapEarly(l9_1,ivec2(SC_SOFTWARE_WRAP_MODE_U_handGlowTex,SC_SOFTWARE_WRAP_MODE_V_handGlowTex).x);
float l9_2=l9_1;
float l9_3=varPackedTex.y;
sc_SoftwareWrapEarly(l9_3,ivec2(SC_SOFTWARE_WRAP_MODE_U_handGlowTex,SC_SOFTWARE_WRAP_MODE_V_handGlowTex).y);
float l9_4=l9_3;
vec2 l9_5;
float l9_6;
#if (SC_USE_UV_MIN_MAX_handGlowTex)
{
bool l9_7;
#if (SC_USE_CLAMP_TO_BORDER_handGlowTex)
{
l9_7=ivec2(SC_SOFTWARE_WRAP_MODE_U_handGlowTex,SC_SOFTWARE_WRAP_MODE_V_handGlowTex).x==3;
}
#else
{
l9_7=(int(SC_USE_CLAMP_TO_BORDER_handGlowTex)!=0);
}
#endif
float l9_8=l9_2;
float l9_9=1.0;
sc_ClampUV(l9_8,handGlowTexUvMinMax.x,handGlowTexUvMinMax.z,l9_7,l9_9);
float l9_10=l9_8;
float l9_11=l9_9;
bool l9_12;
#if (SC_USE_CLAMP_TO_BORDER_handGlowTex)
{
l9_12=ivec2(SC_SOFTWARE_WRAP_MODE_U_handGlowTex,SC_SOFTWARE_WRAP_MODE_V_handGlowTex).y==3;
}
#else
{
l9_12=(int(SC_USE_CLAMP_TO_BORDER_handGlowTex)!=0);
}
#endif
float l9_13=l9_4;
float l9_14=l9_11;
sc_ClampUV(l9_13,handGlowTexUvMinMax.y,handGlowTexUvMinMax.w,l9_12,l9_14);
l9_6=l9_14;
...
#endif
vec2 l9_15=sc_TransformUV(l9_5,(int(SC_USE_UV_TRANSFORM_handGlowTex)!=0),handGlowTexTransform);
float l9_16=l9_15.x;
float l9_17=l9_6;
sc_SoftwareWrapLate(l9_16,ivec2(SC_SOFTWARE_WRAP_MODE_U_handGlowTex,SC_SOFTWARE_WRAP_MODE_V_handGlowTex).x,(int(SC_USE_CLAMP_TO_BORDER_handGlowTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_handGlowTex)!=0)),l9_17);
float l9_18=l9_15.y;
float l9_19=l9_17;
sc_SoftwareWrapLate(l9_18,ivec2(SC_SOFTWARE_WRAP_MODE_U_handGlowTex,SC_SOFTWARE_WRAP_MODE_V_handGlowTex).y,(int(SC_USE_CLAMP_TO_BORDER_handGlowTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_handGlowTex)!=0)),l9_19);
float l9_20=l9_19;
vec3 l9_21=sc_SamplingCoordsViewToGlobal(vec2(l9_16,l9_18),handGlowTexLayout,l9_0);
vec4 l9_22=texture2D(handGlowTex,l9_21.xy,0.0);
vec4 l9_23;
#if (SC_USE_CLAMP_TO_BORDER_handGlowTex)
{
l9_23=mix(handGlowTexBorderColor,l9_22,vec4(l9_20));
}
#else
{
l9_23=l9_22;
...
#endif
float l9_24=mix(Port_Input0_N003,indexBrightness,l9_23.x);
vec4 l9_25=vec4(indexGlowColor.xyz,l9_24);
vec3 l9_26=l9_25.xyz*l9_24;
vec4 l9_27=vec4(l9_26.x,l9_26.y,l9_26.z,l9_25.w)+(vec4(thumbGlowColor.xyz,mix(Port_Input0_N011,thumbBrightness,l9_23.y))*(1.0-l9_24));
float l9_28=l9_27.w;
...
#endif
l9_44=texture2D(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_48,sc_ScreenTextureLayout,l9_49).xy,0.0);
}
#endif
vec4 l9_50;
