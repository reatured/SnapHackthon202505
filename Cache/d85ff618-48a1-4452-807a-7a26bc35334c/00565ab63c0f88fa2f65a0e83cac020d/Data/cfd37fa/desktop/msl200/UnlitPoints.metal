...
//sampler sampler Tweak_N42SmpSC 0:22
...
//texture texture2D Tweak_N42 0:4:0:22
...
//}
//ubo int UserUniforms 0:33:4432 {
...
//float Tweak_N47 4288
//float Tweak_N2 4292
//float4 baseColor 4304
//float Tweak_N41 4320
//float4 Port_Input0_N102 4336
//float2 Port_Center_N046 4352
//float4 Port_Import_N091 4368
//float Port_Import_N092 4384
//float4 Port_Input1_N094 4400
//float Port_Import_N095 4416
//float Port_Import_N100 4420
//float depthRef 4424
//}
...
//spec_const bool SC_USE_CLAMP_TO_BORDER_Tweak_N42 31
//spec_const bool SC_USE_CLAMP_TO_BORDER_intensityTexture 32
//spec_const bool SC_USE_UV_MIN_MAX_Tweak_N42 33
//spec_const bool SC_USE_UV_MIN_MAX_intensityTexture 34
//spec_const bool SC_USE_UV_TRANSFORM_Tweak_N42 35
//spec_const bool SC_USE_UV_TRANSFORM_intensityTexture 36
//spec_const bool Tweak_N42HasSwappedViews 37
...
//spec_const int SC_SOFTWARE_WRAP_MODE_U_Tweak_N42 70
//spec_const int SC_SOFTWARE_WRAP_MODE_U_intensityTexture 71
//spec_const int SC_SOFTWARE_WRAP_MODE_V_Tweak_N42 72
//spec_const int SC_SOFTWARE_WRAP_MODE_V_intensityTexture 73
//spec_const int Tweak_N42Layout 74
...
constant bool SC_USE_CLAMP_TO_BORDER_Tweak_N42 [[function_constant(31)]];
...
constant bool SC_USE_UV_MIN_MAX_Tweak_N42 [[function_constant(33)]];
...
constant bool SC_USE_UV_TRANSFORM_Tweak_N42 [[function_constant(35)]];
...
constant bool Tweak_N42HasSwappedViews [[function_constant(37)]];
...
constant int SC_SOFTWARE_WRAP_MODE_U_Tweak_N42 [[function_constant(70)]];
...
constant int SC_SOFTWARE_WRAP_MODE_V_Tweak_N42 [[function_constant(72)]];
...
constant int Tweak_N42Layout [[function_constant(74)]];
...
float param=(*sc_set0.UserUniforms).Tweak_N47;
Output_N47=param;
float2 CoordsOut_N46=float2(0.0);
CoordsOut_N46=((UVCoord_N45-(*sc_set0.UserUniforms).Port_Center_N046)*float2(Output_N47))+(*sc_set0.UserUniforms).Port_Center_N046;
...
float3x3 param_5=(*sc_set0.UserUniforms).Tweak_N42Transform;
...
float4 param_8=(*sc_set0.UserUniforms).Tweak_N42UvMinMax;
bool param_9=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N42_tmp)!=0);
float4 param_10=(*sc_set0.UserUniforms).Tweak_N42BorderColor;
float param_11=0.0;
...
float l9_82=l9_74;
float4 l9_83=sc_set0.Tweak_N42.sample(sc_set0.Tweak_N42SmpSC,l9_81,bias(l9_82));
float4 l9_84=l9_83;
float4 l9_85=l9_84;
if (param_9)
{
...
float Value_N92=0.0;
Value_N92=fast::clamp((*sc_set0.UserUniforms).Port_Import_N092,0.0,5.0);
float4 Output_N93=float4(0.0);
Output_N93=Value_N91*float4(Value_N92);
float Output_N94=0.0;
Output_N94=dot(Output_N93,(*sc_set0.UserUniforms).Port_Input1_N094);
float Output_N2=0.0;
...
float param_14=(*sc_set0.UserUniforms).Tweak_N41;
Output_N41=param_14;
...
{
if (param_15<(*sc_set0.UserUniforms).alphaTestThreshold)
{
discard_fragment();
}
}
...
bool l9_90=(*sc_set0.UserUniforms).isProxyMode!=0;
if (l9_90)
{
...
float l9_95=l9_94;
float l9_96=l9_95;
float l9_97=(*sc_set0.UserUniforms).sc_ShadowDensity*l9_96;
float3 l9_98=mix((*sc_set0.UserUniforms).sc_ShadowColor.xyz,(*sc_set0.UserUniforms).sc_ShadowColor.xyz*l9_92.xyz,float3((*sc_set0.UserUniforms).sc_ShadowColor.w));
...
{
l9_104.x+=(*sc_set0.UserUniforms)._sc_framebufferFetchMarker;
}
...
float2 l9_107=l9_106.xy*(*sc_set0.UserUniforms).sc_CurrentRenderTargetDims.zw;
...
float l9_144=l9_136;
float4 l9_145=sc_set0.sc_ScreenTexture.sample(sc_set0.sc_ScreenTextureSmpSC,l9_143,bias(l9_144));
float4 l9_146=l9_145;
l9_132=l9_146;
...
float3 l9_155=definedBlend(l9_153,l9_154,in.varStereoViewID,(*sc_set0.UserUniforms),sc_set0.intensityTexture,sc_set0.intensityTextureSmpSC);
...
{
l9_163=float4((*sc_set0.UserUniforms).shaderComplexityValue/255.0,0.0,0.0,1.0);
}
else
{
l9_163=float4(0.0);
...
if (sc_ShaderCacheConstant_tmp!=0)
{
l9_165.x+=((*sc_set0.UserUniforms).sc_UniformConstants.x*float(sc_ShaderCacheConstant_tmp));
}
