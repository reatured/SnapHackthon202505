...
//sampler sampler Tweak_N42SmpSC 0:16
...
//texture texture2D Tweak_N42 0:0:0:16
...
#endif
vec2 l9_0=((varPackedTex.xy-Port_Center_N046)*vec2(Tweak_N47))+Port_Center_N046;
int l9_1;
...
#endif
float l9_2=l9_0.x;
sc_SoftwareWrapEarly(l9_2,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N42,SC_SOFTWARE_WRAP_MODE_V_Tweak_N42).x);
float l9_3=l9_2;
float l9_4=l9_0.y;
sc_SoftwareWrapEarly(l9_4,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N42,SC_SOFTWARE_WRAP_MODE_V_Tweak_N42).y);
float l9_5=l9_4;
vec2 l9_6;
float l9_7;
...
{
l9_8=ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N42,SC_SOFTWARE_WRAP_MODE_V_Tweak_N42).x==3;
}
#else
{
l9_8=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N42)!=0);
}
#endif
float l9_9=l9_3;
float l9_10=1.0;
sc_ClampUV(l9_9,Tweak_N42UvMinMax.x,Tweak_N42UvMinMax.z,l9_8,l9_10);
float l9_11=l9_9;
float l9_12=l9_10;
bool l9_13;
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N42)
{
l9_13=ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N42,SC_SOFTWARE_WRAP_MODE_V_Tweak_N42).y==3;
}
#else
{
l9_13=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N42)!=0);
}
#endif
float l9_14=l9_5;
float l9_15=l9_12;
sc_ClampUV(l9_14,Tweak_N42UvMinMax.y,Tweak_N42UvMinMax.w,l9_13,l9_15);
l9_7=l9_15;
...
#endif
vec2 l9_16=sc_TransformUV(l9_6,(int(SC_USE_UV_TRANSFORM_Tweak_N42)!=0),Tweak_N42Transform);
float l9_17=l9_16.x;
float l9_18=l9_7;
sc_SoftwareWrapLate(l9_17,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N42,SC_SOFTWARE_WRAP_MODE_V_Tweak_N42).x,(int(SC_USE_CLAMP_TO_BORDER_Tweak_N42)!=0)&&(!(int(SC_USE_UV_MIN_MAX_Tweak_N42)!=0)),l9_18);
float l9_19=l9_16.y;
float l9_20=l9_18;
sc_SoftwareWrapLate(l9_19,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N42,SC_SOFTWARE_WRAP_MODE_V_Tweak_N42).y,(int(SC_USE_CLAMP_TO_BORDER_Tweak_N42)!=0)&&(!(int(SC_USE_UV_MIN_MAX_Tweak_N42)!=0)),l9_20);
float l9_21=l9_20;
vec3 l9_22=sc_SamplingCoordsViewToGlobal(vec2(l9_17,l9_19),Tweak_N42Layout,l9_1);
vec4 l9_23=texture2D(Tweak_N42,l9_22.xy,0.0);
vec4 l9_24;
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N42)
{
l9_24=mix(Tweak_N42BorderColor,l9_23,vec4(l9_21));
}
#else
{
l9_24=l9_23;
...
#endif
vec4 l9_25=l9_24*vec4(clamp(Port_Import_N092,0.0,5.0));
vec4 l9_26=mix(Port_Input0_N102,mix(vec4(dot(l9_25,Port_Input1_N094)),l9_25,vec4(clamp(Tweak_N2,0.0,2.0))),vec4(clamp(Port_Import_N100,0.0,2.0)))*baseColor;
...
{
l9_30=clamp(Tweak_N41*2.0,0.0,1.0);
}
#else
{
float l9_31;
...
{
l9_31=clamp(dot(l9_27.xyz,vec3(Tweak_N41)),0.0,1.0);
}
#else
{
float l9_32;
...
{
l9_33=(1.0-dot(l9_27.xyz,vec3(0.33333001)))*Tweak_N41;
}
#else
{
float l9_34;
...
{
l9_34=(1.0-clamp(dot(l9_27.xyz,vec3(1.0)),0.0,1.0))*Tweak_N41;
}
#else
{
float l9_35;
...
{
l9_35=clamp(dot(l9_27.xyz,vec3(1.0)),0.0,1.0)*Tweak_N41;
}
#else
{
float l9_36;
#if (sc_BlendMode_Add)
{
l9_36=clamp(dot(l9_27.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_37;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_37=clamp(dot(l9_27.xyz,vec3(1.0)),0.0,1.0)*Tweak_N41;
}
#else
{
float l9_38;
...
{
l9_38=dot(l9_27.xyz,vec3(0.33333001))*Tweak_N41;
}
#else
{
float l9_39;
#if (sc_BlendMode_Min)
{
l9_39=1.0-clamp(dot(l9_27.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_40;
#if (sc_BlendMode_Max)
{
l9_40=clamp(dot(l9_27.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_40=1.0;
...
#endif
l9_28=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_27.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_29);
}
#else
{
vec4 l9_41;
...
#endif
l9_43=texture2D(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_47,sc_ScreenTextureLayout,l9_48).xy,0.0);
}
#endif
vec4 l9_49;
...
#endif
vec3 l9_51=mix(l9_49.xyz,definedBlend(l9_49.xyz,l9_27.xyz).xyz,vec3(Tweak_N41));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_53=vec4(mix(vec3(1.0),l9_27.xyz,vec3(Tweak_N41)),Tweak_N41);
}
#else
{
vec4 l9_54;
...
#endif
l9_54=vec4(l9_27.xyz*l9_55,l9_55);
}
#else
{
l9_54=l9_27;
...
#if (sc_OITDepthGatherPass)
{
vec2 l9_63=sc_ScreenCoordsGlobalToView(gl_FragCoord.xy*sc_CurrentRenderTargetDims.zw);
