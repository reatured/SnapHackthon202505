...
float4 param=(*sc_set0.UserUniforms).Tweak_N95;
Output_N95=param;
float Output_N129=0.0;
float param_1=(*sc_set0.UserUniforms).alpha;
Output_N129=param_1;
...
{
if (param_2<(*sc_set0.UserUniforms).alphaTestThreshold)
{
discard_fragment();
}
}
...
bool l9_8=(*sc_set0.UserUniforms).isProxyMode!=0;
if (l9_8)
{
...
float l9_13=l9_12;
float l9_14=l9_13;
float l9_15=(*sc_set0.UserUniforms).sc_ShadowDensity*l9_14;
float3 l9_16=mix((*sc_set0.UserUniforms).sc_ShadowColor.xyz,(*sc_set0.UserUniforms).sc_ShadowColor.xyz*l9_10.xyz,float3((*sc_set0.UserUniforms).sc_ShadowColor.w));
...
{
l9_22.x+=(*sc_set0.UserUniforms)._sc_framebufferFetchMarker;
}
float4 l9_23=l9_22;
l9_20=l9_23;
}
...
float2 l9_25=l9_24.xy*(*sc_set0.UserUniforms).sc_CurrentRenderTargetDims.zw;
float2 l9_26=l9_25;
...
float l9_62=l9_54;
float4 l9_63=sc_set0.sc_ScreenTexture.sample(sc_set0.sc_ScreenTextureSmpSC,l9_61,bias(l9_62));
float4 l9_64=l9_63;
l9_50=l9_64;
float4 l9_65=l9_50;
float4 l9_66=l9_65;
...
float3 l9_73=definedBlend(l9_71,l9_72,in.varStereoViewID,(*sc_set0.UserUniforms),sc_set0.intensityTexture,sc_set0.intensityTextureSmpSC);
...
{
l9_81=float4((*sc_set0.UserUniforms).shaderComplexityValue/255.0,0.0,0.0,1.0);
}
else
{
l9_81=float4(0.0);
...
if (sc_ShaderCacheConstant_tmp!=0)
{
l9_83.x+=((*sc_set0.UserUniforms).sc_UniformConstants.x*float(sc_ShaderCacheConstant_tmp));
}
