...
#endif
bool l9_0=(float(enableStripes)*1.0)!=0.0;
bool l9_1;
if (l9_0)
{
l9_1=(float((mod(varPackedTex.xy*stripeScale,Port_Input1_N007)/(Port_Input1_N002+vec2(1.234e-06))).x>stripes)*1.0)!=0.0;
}
else
{
l9_1=l9_0;
...
{
l9_6=clamp(Port_Value2_N001*2.0,0.0,1.0);
}
#else
{
float l9_7;
...
{
l9_7=clamp(dot(l9_3.xyz,vec3(Port_Value2_N001)),0.0,1.0);
}
#else
{
float l9_8;
...
{
l9_9=(1.0-dot(l9_3.xyz,vec3(0.33333001)))*Port_Value2_N001;
}
#else
{
float l9_10;
...
{
l9_10=(1.0-clamp(dot(l9_3.xyz,vec3(1.0)),0.0,1.0))*Port_Value2_N001;
}
#else
{
float l9_11;
...
{
l9_11=clamp(dot(l9_3.xyz,vec3(1.0)),0.0,1.0)*Port_Value2_N001;
}
#else
{
float l9_12;
...
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_13=clamp(dot(l9_3.xyz,vec3(1.0)),0.0,1.0)*Port_Value2_N001;
}
#else
{
float l9_14;
...
{
l9_14=dot(l9_3.xyz,vec3(0.33333001))*Port_Value2_N001;
}
#else
{
float l9_15;
...
#else
{
vec2 l9_23=sc_ScreenCoordsGlobalToView(gl_FragCoord.xy*sc_CurrentRenderTargetDims.zw);
int l9_24;
...
#endif
l9_19=texture2D(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_23,sc_ScreenTextureLayout,l9_24).xy,0.0);
}
#endif
vec4 l9_25;
...
#endif
vec3 l9_27=mix(l9_25.xyz,definedBlend(l9_25.xyz,l9_3.xyz).xyz,vec3(Port_Value2_N001));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_29=vec4(mix(vec3(1.0),l9_3.xyz,vec3(Port_Value2_N001)),Port_Value2_N001);
}
#else
{
vec4 l9_30;
...
{
l9_31=clamp(Port_Value2_N001,0.0,1.0);
}
#else
{
l9_31=Port_Value2_N001;
}
#endif
...
#if (sc_OITDepthGatherPass)
{
vec2 l9_39=sc_ScreenCoordsGlobalToView(gl_FragCoord.xy*sc_CurrentRenderTargetDims.zw);
