...
//sampler sampler z_hitIdAndBarycentricSmp 0:29
//sampler sampler z_rayDirectionsSmpSC 0:30
//texture texture2D intensityTexture 0:4:0:21
//texture texture2D sc_ScreenTexture 0:16:0:26
//texture utexture2D z_hitIdAndBarycentric 0:19:0:29
//texture texture2D z_rayDirections 0:20:0:30
//ubo float sc_BonesUBO 0:3:96 {
//sc_Bone_t sc_Bones 0:[]:96
//float4 sc_Bones.boneMatrix 0:[3]:16
//float4 sc_Bones.normalMatrix 48:[3]:16
//}
//ubo int UserUniforms 0:31:4240 {
...
//bool enableStripes 4148
//float2 stripeScale 4152
//float stripes 4160
//float4 baseColor 4176
//float4 stripeColor 4192
//float2 Port_Input1_N007 4208
//float2 Port_Input1_N002 4216
//float Port_Value2_N001 4224
//float depthRef 4228
//}
...
//spec_const bool sc_ProxyAlphaOne 59
//spec_const bool sc_RenderAlphaToColor 60
//spec_const bool sc_ScreenTextureHasSwappedViews 61
//spec_const bool sc_ShaderComplexityAnalyzer 62
//spec_const bool sc_UseFramebufferFetchMarker 63
//spec_const bool sc_VertexBlendingUseNormals 64
//spec_const bool sc_VertexBlending 65
//spec_const int SC_SOFTWARE_WRAP_MODE_U_intensityTexture 66
//spec_const int SC_SOFTWARE_WRAP_MODE_V_intensityTexture 67
//spec_const int intensityTextureLayout 68
//spec_const int sc_DepthBufferMode 69
//spec_const int sc_RenderingSpace 70
//spec_const int sc_ScreenTextureLayout 71
//spec_const int sc_ShaderCacheConstant 72
//spec_const int sc_SkinBonesCount 73
//spec_const int sc_StereoRenderingMode 74
//spec_const int sc_StereoRendering_IsClipDistanceEnabled 75
//SG_REFLECTION_END
...
constant bool sc_ProxyAlphaOne [[function_constant(59)]];
...
constant bool sc_ShaderComplexityAnalyzer [[function_constant(62)]];
constant bool sc_ShaderComplexityAnalyzer_tmp = is_function_constant_defined(sc_ShaderComplexityAnalyzer) ? sc_ShaderComplexityAnalyzer : false;
constant bool sc_UseFramebufferFetchMarker [[function_constant(63)]];
constant bool sc_UseFramebufferFetchMarker_tmp = is_function_constant_defined(sc_UseFramebufferFetchMarker) ? sc_UseFramebufferFetchMarker : false;
constant bool sc_VertexBlendingUseNormals [[function_constant(64)]];
constant bool sc_VertexBlendingUseNormals_tmp = is_function_constant_defined(sc_VertexBlendingUseNormals) ? sc_VertexBlendingUseNormals : false;
constant bool sc_VertexBlending [[function_constant(65)]];
...
float4 Result_N9=float4(0.0);
float param=0.0;
float4 param_1=float4(0.0);
float4 param_2=float4(1.0);
ssGlobals param_4=Globals;
float l9_7=0.0;
float l9_8=float((*sc_set0.UserUniforms).enableStripes!=0);
l9_7=l9_8;
float2 l9_9=float2(0.0);
l9_9=param_4.Surface_UVCoord0;
float2 l9_10=float2(0.0);
float2 l9_11=(*sc_set0.UserUniforms).stripeScale;
l9_10=l9_11;
float2 l9_12=float2(0.0);
l9_12=l9_9*l9_10;
float2 l9_13=float2(0.0);
l9_13=mod(l9_12,(*sc_set0.UserUniforms).Port_Input1_N007);
float2 l9_14=float2(0.0);
l9_14=l9_13/((*sc_set0.UserUniforms).Port_Input1_N002+float2(1.234e-06));
float l9_15=0.0;
float l9_16=(*sc_set0.UserUniforms).stripes;
l9_15=l9_16;
float2 l9_17=float2(0.0);
l9_17=float2(float(l9_14.x>l9_15),float(l9_14.y>l9_15));
float l9_18=0.0;
float l9_19=l9_7;
...
float4 l9_23=(*sc_set0.UserUniforms).baseColor;
l9_22=l9_23;
param_1=l9_22;
param_3=param_1;
}
...
float4 l9_25=(*sc_set0.UserUniforms).stripeColor;
l9_24=l9_25;
param_2=l9_24;
param_3=param_2;
}
...
Value_N1=float4(Result_N9.xyz.x,Result_N9.xyz.y,Result_N9.xyz.z,Value_N1.w);
...
{
float4 l9_26=gl_FragCoord;
float2 l9_27=floor(mod(l9_26.xy,float2(4.0)));
float l9_28=(mod(dot(l9_27,float2(4.0,1.0))*9.0,16.0)+1.0)/17.0;
if (param_5<l9_28)
{
discard_fragment();
}
}
bool l9_29=(*sc_set0.UserUniforms).isProxyMode!=0;
if (l9_29)
{
...
float4 l9_30=fast::max(param_6,float4(0.0));
float4 param_7=l9_30;
if (sc_ShaderCacheConstant_tmp!=0)
{
...
{
l9_33=fast::clamp(l9_32.w*2.0,0.0,1.0);
}
else
{
if ((int(sc_BlendMode_AddWithAlphaFactor_tmp)!=0))
{
l9_33=fast::clamp(dot(l9_32.xyz,float3(l9_32.w)),0.0,1.0);
}
else
{
if ((int(sc_BlendMode_AlphaTest_tmp)!=0))
...
{
l9_33=(1.0-dot(l9_32.xyz,float3(0.33333001)))*l9_32.w;
}
else
{
if ((int(sc_BlendMode_MultiplyOriginal_tmp)!=0))
{
l9_33=(1.0-fast::clamp(dot(l9_32.xyz,float3(1.0)),0.0,1.0))*l9_32.w;
}
else
{
if ((int(sc_BlendMode_ColoredGlass_tmp)!=0))
{
l9_33=fast::clamp(dot(l9_32.xyz,float3(1.0)),0.0,1.0)*l9_32.w;
}
else
{
if ((int(sc_BlendMode_Add_tmp)!=0))
{
l9_33=fast::clamp(dot(l9_32.xyz,float3(1.0)),0.0,1.0);
}
else
{
if ((int(sc_BlendMode_AddWithAlphaFactor_tmp)!=0))
...
{
l9_33=dot(l9_32.xyz,float3(0.33333001))*l9_32.w;
}
else
{
if ((int(sc_BlendMode_Min_tmp)!=0))
{
l9_33=1.0-fast::clamp(dot(l9_32.xyz,float3(1.0)),0.0,1.0);
}
else
{
...
float l9_34=l9_33;
float l9_35=l9_34;
float l9_36=(*sc_set0.UserUniforms).sc_ShadowDensity*l9_35;
float3 l9_37=mix((*sc_set0.UserUniforms).sc_ShadowColor.xyz,(*sc_set0.UserUniforms).sc_ShadowColor.xyz*l9_31.xyz,float3((*sc_set0.UserUniforms).sc_ShadowColor.w));
float4 l9_38=float4(l9_37.x,l9_37.y,l9_37.z,l9_36);
param_8=l9_38;
}
else
{
...
{
float4 l9_39=param_8;
float4 l9_40=float4(0.0);
float4 l9_41=float4(0.0);
if ((int(sc_FramebufferFetch_tmp)!=0))
{
float4 l9_42=out.FragColor0;
float4 l9_43=l9_42;
if ((int(sc_UseFramebufferFetchMarker_tmp)!=0))
{
l9_43.x+=(*sc_set0.UserUniforms)._sc_framebufferFetchMarker;
}
float4 l9_44=l9_43;
l9_41=l9_44;
}
...
{
float4 l9_45=gl_FragCoord;
float2 l9_46=l9_45.xy*(*sc_set0.UserUniforms).sc_CurrentRenderTargetDims.zw;
float2 l9_47=l9_46;
...
int l9_51=l9_50;
int l9_52=l9_51;
float3 l9_53=float3(l9_47,0.0);
int l9_54=l9_49;
int l9_55=l9_52;
if (l9_54==1)
{
l9_53.y=((2.0*l9_53.y)+float(l9_55))-1.0;
}
float2 l9_56=l9_53.xy;
l9_48=l9_56;
}
else
{
...
float2 l9_72=l9_68;
int l9_73=sc_ScreenTextureLayout_tmp;
int l9_74=l9_69;
float l9_75=l9_70;
float2 l9_76=l9_72;
int l9_77=l9_73;
...
float l9_83=l9_75;
float4 l9_84=sc_set0.sc_ScreenTexture.sample(sc_set0.sc_ScreenTextureSmpSC,l9_82,bias(l9_83));
float4 l9_85=l9_84;
l9_71=l9_85;
float4 l9_86=l9_71;
float4 l9_87=l9_86;
...
float4 l9_89=l9_41;
float4 l9_90=l9_89;
float3 l9_91=l9_90.xyz;
float3 l9_92=l9_91;
float3 l9_93=l9_39.xyz;
float3 l9_94=definedBlend(l9_92,l9_93,in.varStereoViewID,(*sc_set0.UserUniforms),sc_set0.intensityTexture,sc_set0.intensityTextureSmpSC);
l9_40=float4(l9_94.x,l9_94.y,l9_94.z,l9_40.w);
float3 l9_95=mix(l9_91,l9_40.xyz,float3(l9_39.w));
l9_40=float4(l9_95.x,l9_95.y,l9_95.z,l9_40.w);
l9_40.w=1.0;
float4 l9_96=l9_40;
param_8=l9_96;
}
...
{
float4 l9_97=param_8;
float4 l9_98=float4(0.0);
if ((int(sc_BlendMode_MultiplyOriginal_tmp)!=0))
{
l9_98=float4(mix(float3(1.0),l9_97.xyz,float3(l9_97.w)),l9_97.w);
}
else
{
...
l9_98=float4(l9_97.xyz*l9_99,l9_99);
}
else
{
l9_98=l9_97;
...
{
l9_102=float4((*sc_set0.UserUniforms).shaderComplexityValue/255.0,0.0,0.0,1.0);
}
else
{
l9_102=float4(0.0);
...
float4 l9_104=param_11;
if (sc_ShaderCacheConstant_tmp!=0)
{
l9_104.x+=((*sc_set0.UserUniforms).sc_UniformConstants.x*float(sc_ShaderCacheConstant_tmp));
}
out.FragColor0=l9_104;
return out;
}
} // FRAGMENT SHADER
